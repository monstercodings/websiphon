...
public interface WebPlugin extends WebType {
    Object[] before(Object[] params, ReturnPoint point) throws WebException;

    Object after(Object proxy, Object[] params, Object result, MethodDesc methodDesc, ReturnPoint point) throws WebException;
